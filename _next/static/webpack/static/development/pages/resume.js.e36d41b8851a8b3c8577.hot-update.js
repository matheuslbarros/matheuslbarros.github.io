...
var Resume = function Resume(props) {
  ...
  }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("title", null, "Resume - ", props.user.first_name, " ", props.user.last_name, " - ", props.user.headline), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("link", {
    rel: "stylesheet",
    href: "/_next/static/css/styles.chunk.css"
  })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Profile__WEBPACK_IMPORTED_MODULE_3__["default"], {
    user: props.user,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 2;
            _context2.next = 5;
            return fetchJson('http://localhost:59334/assets/json/user.json');

          case 5:
            props.user = _context2.sent;
            _context2.next = 8;
            return fetchJson('http://localhost:59334/assets/json/profile.json');
...
//# sourceMappingURL=resume.js.e36d41b8851a8b3c8577.hot-update.js.map